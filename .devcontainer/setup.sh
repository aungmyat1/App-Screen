...
echo ""
echo "🌐 Ports:"
echo "   - Frontend: http://localhost:5173 (automatically opened in browser)"
...
echo ""
echo "ℹ️  Note: After setup completes, services will be automatically started"
echo "    when you attach to the devcontainer. Check the terminal output for"
